...
//		방문자수 카운트
	...
	public String mustEatPlaceInfo(@RequestParam String id, Model model) {
		...
		List<MainMustEatPlaceMenuInfo> mainMustEatPlaceMenuInfoById = mustEatPlaceService.mainFindMustEatPlaceMenuById(intId);
		
		List<MainMustEatPlaceReview> mainMustEatPlaceReviewById = mustEatPlaceService.mainFindMustEatPlaceReviewById(intId);
